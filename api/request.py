...
trade_points = {32: 'nidoran♂', 678: 'meowstic♂', 876:'indeedee', 29: 'nidoran♀', 122: "mr Mime", 866: "mr Rime", 439: 'Mime jr'}
...
def pokemon_start(list_poke, form=False, list_ =pokelist):
    ...
    for number in list_poke:
        ...
        if not form:
            ...
            pokemon['evolution_base'] = chain['chain']['species']['url'].split('/')[-2]
...
for pokemons in pokelist:
    ...
    pokemons['id'] = '0' * (3 - len(str(pokemons['id']))) + str(pokemons['id'])
