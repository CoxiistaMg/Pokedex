    ...
    def return_evolution_method_to_string(method):
        ...
        for name in method:
            if name in trade_maps:
                ...
                elements.append(trade_strings[name].replace('...', str(method[name])))
    ...
    if pokemon:
        ...
        for pos, evolution in enumerate(chain):
            ...
            if evolution['evolution_details']:
                ...
                evolution_chain[pos].append({'name': evolution_name,'method': return_evolution_method_to_string(methods_valids)})
...
print(pokelist[0]['evolution_to'])
print(pokelist[133]['evolution_to'])
print(pokelist[265]['evolution_to'])